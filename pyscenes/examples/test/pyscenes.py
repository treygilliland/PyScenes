...
# contains methods/data related to running the game and managing scenes
...
class Runner:
    def __init__(self, width, height, fps):
        ...
        self.scene_dict = {}  # dictionary of scenes to store state between scenes
        self.fps = fps
    ...
    def run_game(self, starting_scene):
        ...
        while self.current_scene is not None:
            ...
            self.current_scene.render(screen)  # pass a pyGame screen object here
    ...
    def next_scene(self):
        ...
        if self.current_scene.next is not self.current_scene:
            ...
            print("Switching from {} to {}...".format(self.current_scene, self.current_scene.next))
